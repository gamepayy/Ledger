...
const pendingWithdrawalsTableCreation = "CREATE TABLE `pending_withdrawals` (`address` varchar(256) NOT NULL, `token_address` varchar(256) NOT NULL, `amount` varchar(256), `pending` BOOL, `issueTimestamp` int(256), PRIMARY KEY (`address`, `token_address`))"
